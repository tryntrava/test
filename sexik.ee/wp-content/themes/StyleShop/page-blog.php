		...
		<div id="et_pt_blog" class="responsive clearfix">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="et_pt_blogentry clearfix">
					...
					<p class="et_pt_blogmeta"><?php esc_html_e('Posted','StyleShop'); ?> <?php esc_html_e('by','StyleShop'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','StyleShop'); ?> <?php the_time(get_option('styleshop_date_format')) ?> <?php esc_html_e('in','StyleShop'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','StyleShop'), esc_html__('1 comment','StyleShop'), '% '.esc_html__('comments','StyleShop')); ?></p>
