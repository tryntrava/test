			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="et_pt_gallery_entry">
					<div class="et_pt_item_image">
						...
						<a class="zoom-icon fancybox" title="<?php the_title_attribute(); ?>" rel="gallery" href="<?php echo esc_url($thumbnail['fullpath']); ?>"><?php esc_html_e('Zoom in','StyleShop'); ?></a>
						<a class="more-icon" href="<?php the_permalink(); ?>"><?php esc_html_e('Read more','StyleShop'); ?></a>
