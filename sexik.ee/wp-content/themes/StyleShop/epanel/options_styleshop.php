...
if ( class_exists( 'woocommerce' ) ) {
	...
	foreach ( $et_ecommerce_caterogies as $ecommerce_caterogy ){
		$woocommerce_site_cats[$ecommerce_caterogy->term_id] = $ecommerce_caterogy->name;
		$woocommerce_cats_ids[] = $ecommerce_caterogy->term_id;
	}
}
...
$woocommerce_cats_ids 	= array_map( 'intval', $woocommerce_cats_ids );
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => esc_html__("Main Background Image",$themename),
				   ...
				   "type" => "upload",
				   "std" => "",
				   "desc" => esc_html__("Here you can upload the main background image.",$themename)
			),
			...
			array( "name" => esc_html__("Show Checkout Button in Navigation area",$themename),
                   "id" => $shortname."_show_checkout_button",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the checkout button near the top menu. ",$themename)
			),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Display Special Offers",$themename),
                   "id" => $shortname."_display_offers",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display Special Offers on the homepage. ",$themename)
			),

			array( "name" => esc_html__("Display Products On Sale",$themename),
                   "id" => $shortname."_home_products_onsale",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display Products On Sale on the homepage. ",$themename)
			),

			array( "type" => "clearfix",),

			array( "name" => esc_html__("Display New Products",$themename),
                   "id" => $shortname."_home_new_items",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display new products on the homepage. Note: new products don't show up on homepage, if the 'Blog style mode' option is activated.",$themename)
			),
			...
			array( "name" => esc_html__("Number of posts in the Special Offers slider",$themename),
                   "id" => $shortname."_home_offers_number",
                   "std" => '6',
                   "type" => "text",
				   "desc" => esc_html__("Here you can choose the number of special offers on the homepage. ",$themename),
				   "validation_type" => "number"
			),

			array( "name" => esc_html__("Number of products on sale",$themename),
                   "id" => $shortname."_sale_products_number",
                   "std" => '8',
                   "type" => "text",
				   "desc" => esc_html__("Here you can choose the number of products on sale on the homepage. ",$themename),
				   "validation_type" => "number"
			),

			array( "name" => esc_html__("Number of Recent Posts / Products displayed on homepage",$themename),
			...
			array( "name" => esc_html__("Exclude categories from homepage recent products",$themename),
				   "id" => $shortname."_exlcats_recent_products",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => esc_html__("By default the homepage displays a list of all of your most recent products. However, if you would like to exlcude certain products category from the list you can do so here. ",$themename),
				   "usefor" => "taxonomy_terms",
				   "taxonomy_name" => "product_cat",
				   "options" => $woocommerce_cats_ids),
		...
		array( "name" => "general-3",
			...
			array( "name" => esc_html__("Featured Products Category",$themename),
	               "id" => $shortname."_feat_products_cat",
	               "type" => "select",
			       "options" => $woocommerce_site_cats,
			       "et_array_for" => "categories",
				   "desc" => esc_html__("Here you can choose which category to be used to populate the Featured Slider on the homepage. This only applies if you have disabled 'Use Pages' and enabled 'Use Products' options below.",$themename),
				   "et_array_for" => "categories"
			),

			array( "name" => esc_html__("Use products",$themename),
                   "id" => $shortname."_use_products_for_slider",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => esc_html__("The homepage Featured Slider can be set up using 3 methods. You can populate the slider using Posts, Products or you can populate it using Pages. If you would like to use Products in the Featured Slider then enable this option.",$themename)
			),
			...
			array( "name" => esc_html__("Use pages",$themename),
                   ...
                   "type" => "checkbox2",
                   "std" => "false",
                   "desc" => esc_html__("The homepage Featured Slider can be set up using 3 methods. You can populate the slider using Posts, Products or you can populate it using Pages. If you would like to use Pages in the Featured Slider then enable this option.",$themename)
			),
