...
Description: Import to WooCommerce. Adds a tab in Step 4 of WP All Import that looks just like WooCommerce. Requires WP All Import.
Version: 1.3.5
Author: Soflyy
*/
/**
...
if ( class_exists('PMWI_Plugin') and PMWI_EDITION == "free"){
	...
	if (!empty($options['info_api_url'])){
		// setup the updater
		$updater = new PMWI_Updater( $options['info_api_url'], __FILE__, array( 
