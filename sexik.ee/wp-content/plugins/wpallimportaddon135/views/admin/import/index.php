					...
					<div class="panel woocommerce_options_panel" id="add_on_options" style="display:none;">
						...
						<div class="options_group show_if_variable">
							...
							<div class="input" style="padding-left:20px;">
								...
								<label for="set_parent_stock"><?php _e('Set _stock value for parent product.', 'pmxi_plugin') ?></label>								
								<a href="#help" class="help" title="<?php _e('This option works when there are no parent products in your feed ( cases 2 and 4 on Variations tab).', 'pmxi_plugin') ?>" style="position:relative; top:-2px;">?</a>
							</div>
						</div>
					</div>
				</div>
