				...
				<tbody>				
					<?php if (!empty($post['custom_name'])):?>
						<?php foreach ($post['custom_name'] as $i => $name): ?>
							<tr class="form-field">
								<td>
									<input type="text" name="custom_name[]"  value="<?php echo esc_attr($name) ?>" class="widefat"/>
								...
								<td class="action">
									<div class="custom_type" rel="default" <?php if ( ! empty($post['custom_format'][$i]) ): ?>style="display:none;"<?php endif; ?>>
										<textarea name="custom_value[]" class="widefat"><?php echo esc_html($post['custom_value'][$i]) ?></textarea>
									</div>
													...
													if (!empty($serialized_values) and is_array($serialized_values)){
														foreach ($serialized_values as $key => $value) {
															...
															<tr class="form-field">
																...
																<td>
																	<input type="text" class="serialized_value widefat" value="<?php echo (is_array($value)) ? $value[$k] : $value; ?>">
																</td>
					...
					<?php else: ?>
						<tr class="form-field">
							<td>
								<input type="text" name="custom_name[]"  value="" class="widefat"/>
								<div class="input to_the_left">																		
