...
class PMXI_Admin_Addons extends PMXI_Controller_Admin {		
	...
	public function index() {
		...
		$this->data['free']['PMLCA_Plugin'] = array(
			'title' => __("Affiliate Link Cloaking Addon - free edition",'pmxi_plugin'),
			'description' => __("Cloak your links",'pmxi_plugin'),
			'thumbnail' => 'http://placehold.it/220x220',
			'active' => (class_exists('PMLCA_Plugin') and PMWI_EDITION == 'free'),
			'paid_installed' => (class_exists('PMLCA_Plugin') and PMWI_EDITION == 'paid'),
			'required_plugins' => false,
			'url' => 'http://www.wpallimport.com'
		);
		$this->data['free']['PMUI_Plugin'] = array(
			'title' => __("User Import Addon - free edition",'pmxi_plugin'),
			'description' => __("Import users & user's meta",'pmxi_plugin'),
			'thumbnail' => 'http://placehold.it/220x220',
			'active' => (class_exists('PMUI_Plugin') and PMUI_EDITION == 'free'),
			'paid_installed' => (class_exists('PMUI_Plugin') and PMUI_EDITION == 'paid'),
			'required_plugins' => false,
			'url' => 'http://www.wpallimport.com'
		);
